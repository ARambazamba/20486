...
namespace Vouchers.Api
{
    ...
    public class VouchersController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        [HttpGet("{id}")]
        public ActionResult<Voucher> Get(int id)
        {
        ...
        [HttpPost]
        public ActionResult<Voucher> Post([FromBody]Voucher value)
        {
        ...
        [HttpPut()]
        public ActionResult<Voucher> Put([FromBody]Voucher value) //Classic .NET Core WebApi pattern: public void Put(int id, [FromBody]Voucher value)
        {
            //Set Change Tracker
            // ctx.Add(value);
